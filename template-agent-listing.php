                                        ...
                                        <article class="about-agent clearfix">
                                            ...
                                            <div class="follow-agent clearfix">
                                                ...
                                                if(!empty($agent_email)){
                                                    ?><a class="real-btn btn" href="mailto:<?php  echo $agent_email; ?>"><?php _e('Send Message','framework'); ?></a><?php
                                                }
                                                ...
                                                if(!empty($facebook_url) || !empty($twitter_url) || !empty($google_plus_url) || !empty($linked_in_url)){
                                                    ...
                                                    <ul class="social_networks clearfix">
                                                        ...
                                                        if(!empty($facebook_url)){
                                                            ?>
                                                            <li class="facebook">
                                                                <a target="_blank" href="<?php echo $facebook_url; ?>"><i class="icon-facebook"></i></a>
                                                            </li>
                                                            <?php
                                                        }
                                                        if(!empty($twitter_url)){
                                                            ?>
                                                            <li class="twitter">
                                                                <a target="_blank" href="<?php echo $twitter_url; ?>" ><i class="icon-twitter"></i></a>
                                                            </li>
                                                            <?php
                                                        }
                                                        if(!empty($linked_in_url)){
                                                            ?>
                                                            <li class="linkedin">
                                                                <a target="_blank" href="<?php echo $linked_in_url; ?>"><i class="icon-linkedin"></i></a>
                                                            </li>
                                                            <?php
                                                        }
                                                        ...
                                                        if(!empty($google_plus_url)){
                                                            ?>
                                                            <li class="gplus">
                                                                <a target="_blank" href="<?php echo $google_plus_url; ?>"><i class="icon-google-plus"></i></a>
                                                            </li>
                                                            <?php
                                                        }
                                                        ?>
